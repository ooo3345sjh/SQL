...
insert into `professor` values('P11103', 11, '김춘추', '780412-1234567', '010-2101-1979', 'kimcc@hg.ac.kr', '서울');
insert into `professor` values('P11104', 11, '이사부', '650911-1234567', '010-2104-1966', 'leesabu@hg.ac.kr', '서울');
insert into `professor` values('P22110', 22, '장보고', '780727-1234567', '010-3101-1979', 'jangbg@hg.ac.kr', '서울');
insert into `professor` values('P23102', 23, '선덕여왕', '830614-1234567', '010-4101-1984', 'gueen@hg.ac.kr', '서울');
insert into `professor` values('P31101', 31, '강감찬', '641020-1234567', '010-5101-1965', 'kang@hg.ac.kr', '서울');
insert into `professor` values('P31104', 31, '신사임당', '711127-1234567', '010-6101-1972', 'sinsa@hg.ac.kr', '서울');
insert into `professor` values('P40101', 40, '이이', '910906-1234567', '010-7103-1992', 'leelee@hg.ac.kr', '서울');
...
insert into `students` values('20111013', 11, 'P11103' ,'이나영' , '790413-1234567', '010-2101-7904', 'lee@naver.com', '서울');
insert into `students` values('20111014', 11, 'P11104' ,'원빈' , '660912-1234567', '010-2104-6609', 'one@daum.net', '서울');
insert into `students` values('21221010', 22, 'P22110' ,'장동건' , '790728-1234567', '010-3101-7907', 'jang@naver.com', '서울');
insert into `students` values('21231002', 23, 'P23102' ,'고소영' , '840615-1234567', '010-4101-8406', 'goso@daum.net', '서울');
insert into `students` values('22311011', 31, 'P31104' ,'김연아' , '651021-1234567', '010-5101-6510', 'yuna@daum.net', '서울');
insert into `students` values('22311014', 31, 'P31104' ,'유재석' , '721128-1234567', '010-6101-7211', null, '서울');
insert into `students` values('22401001', 40, 'P40101' ,'강호동' , '920907-1234567', '010-7103-9209', null, '서울');
