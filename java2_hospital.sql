...
insert into `patients` values('P103102', 'D103101', 'N103101', '장동건', '790728-1234567', 'M', '대구', '010-3101-7907', 'jang@daum.net', '배우');
...
#차트 테이블에 데이터 입력하기
insert into `charts` values('C1021001', 1021001, 'D102101', 'P102101', '감기 주사 및 약 처');
...
join `nurses` as c on a.dep_no = c.dep_no
join `patients` as d on b.doc_id = d.doc_id and c.nur_id = d.nur_id
join `treatments` as e on e.doc_id = b.doc_id = e.pat_id = d.pat_id
join `charts` as f on f.doc_id = b.doc_id and f.pat_id = d.pat_id and f.treat_no = e.treat_no;
